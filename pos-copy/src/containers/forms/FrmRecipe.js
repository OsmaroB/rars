...
import validation from "containers/validations/ValidationRecipe";
import Cookies from 'universal-cookie';

const FrmRecipe = (props)=>{
            ...
            <Card className="question d-flex mb-4">
                <div className="d-flex flex-grow-1 min-width-zero">
                    ...
                    <div className="custom-control custom-checkbox pl-1 align-self-center pr-4">
                        <Button
                            outline
                            color={recipe.status === 0 ? 'theme-3' : 'light'}
                        ...
                        <Button
                            ...
                            onClick={() => {removeClick()}}
                        >
                            <i className={recipe.status === 0? 'simple-icon-ban' : 'simple-icon-check'} />
                        </Button>
                    </div>
                </div>
                                ...
                                <FormGroup>
                                    ...
                                    <div className="text-right">
                                        <Button
                                            ...
                                            color="primary"
                                            className="m-1"
                                            onClick={() => {dispatch({type: CLOSE_FORM_RECIPE})}}
                                        >
